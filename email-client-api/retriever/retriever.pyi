...
class Retriever:
    ...
    def __exit__(self, type: Exception, value: str,
    ...
    def copy(self, uid: bytes, destination_folder:
             Union[bytes, str]) -> Tuple[str, Union[list, List[None, bytes]]]: ...

    def move(self, uid: bytes,
             destination_folder: Union[bytes, str]) -> None: ...
